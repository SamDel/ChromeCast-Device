...
namespace ChromeCast.Device.Application
{
    public class Device : IDisposable
    {
        ...
        public Device(bool log, string deviceNameIn, string groupNamesIn)
        {
            DeviceName = deviceNameIn;
            GroupNames = groupNamesIn?.Split(new char[] { ',', ';' }, StringSplitOptions.RemoveEmptyEntries | StringSplitOptions.TrimEntries);
